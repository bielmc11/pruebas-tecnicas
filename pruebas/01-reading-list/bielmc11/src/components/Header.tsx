...
export const Header = () => {
  ...
  return (
    <div id='header' className="min-w-screen overflow-hidden min-h-screen z-0 flex relative bg-gray-100 text-gray-900 justify-center items-center box-border font-serif">
      <GradientGrillBg/>
        ...
        <div className='header_wrapper container p-0 pt-4 sm:pt-0 px-6 2xl:px-0 flex flex-col-reverse lg:flex-row justify-between gap-2 xl:gap-8'>
          ...
          <div className="header_img flex items-center max-h-[450px] sm:max-h-[650px]  md:max-h-[750px] justify-center lg:justify-end overflow-hidden rounded-md">
            <img className="object-cover rounded-md relative w-full lg:max-w-[600px] md:max-h-[85%]" src="/src/assets/imagen-in-WEBP.webp" alt="Imagen de portada"/>
          </div>
